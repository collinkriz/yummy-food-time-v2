...
function buildRecipeHTML(recipe) {
  ...
  if (recipe.source_url) {
    html += `<div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid #eee;">
      <a href="${recipe.source_url}" target="_blank" style="display: block; text-align: center; padding: 10px; background: #f5f5f5; border-radius: 6px; color: #666; font-weight: 600; font-size: 13px; text-decoration: none;">🌐 View Original Recipe</a>
    </div>`;
  }
